...
router.post('/submit',cors(corsOptions),(req,res)=>{
...
router.get('/fetchClassrooms', async (req, res) => {
    try {
...
router.post('/fetchTeacherLogs', async (req, res) => {
    try {
...
router.post('/fetchClassLogs', async (req, res) => {
    try {
